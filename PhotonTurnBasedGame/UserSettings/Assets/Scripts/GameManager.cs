...
public class GameManager : MonoBehaviourPun
{
    ...
    void SetNextTurn ()
    {
        ...
        if(curPlayer == null)
            ...
            Debug.Log(curPlayer.name + "'s turn \n");
        ...
        // print the players' photon view IDs in the console
        Debug.Log("Left Player PhotonView ID: " + leftPlayer.photonView.ViewID);
        Debug.Log("Right Player PhotonView ID: " + rightPlayer.photonView.ViewID);
    }
